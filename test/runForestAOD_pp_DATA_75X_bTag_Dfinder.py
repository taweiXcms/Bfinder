...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring('file:./9220B5AA-9791-E511-96B2-02163E011A08_AOD.root')
)
...
process.Bfinder = cms.EDAnalyzer("Bfinder",
    ...
    Bchannel = cms.vint32(0, 0, 0, 0, 0,
        0, 0),
    GenLabel = cms.InputTag("genParticles"),
    HLTLabel = cms.InputTag("TriggerResults","","HLT"),
    MVAMapLabel = cms.string('generalTracks'),
    MaxDocaCut = cms.double(999.0),
...
process.Dfinder = cms.EDAnalyzer("Dfinder",
    ...
    alphaCut = cms.double(999.0),
    dEtaCut = cms.double(2.4),
    dPtCut = cms.double(1.0),
    doTkPreCut = cms.bool(True),
    svpvDistanceCut = cms.double(1.0),
