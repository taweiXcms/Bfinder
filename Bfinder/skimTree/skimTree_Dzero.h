  ...
  if(isPbPb==1)
    {
      ...
      nthlt->SetBranchStatus("HLT_HIPuAK4CaloJet40_Eta5p1_v1",1);
      nthlt->SetBranchStatus("HLT_HIPuAK4CaloJet60_Eta5p1_v1",1);
      nthlt->SetBranchStatus("HLT_HIPuAK4CaloJet80_Eta5p1_v1",1);
